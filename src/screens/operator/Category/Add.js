...
import { createCategory } from "../../../service/useCategory";
export default () => {
  ...
  const saveCategory = () => {
    createCategory(state.token, category)
      .then((result) => {
        ToastAndroid.show(`Шинээр категори нэмэгдлээ`, ToastAndroid.SHORT);
